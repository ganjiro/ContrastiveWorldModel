...
if __name__ == "__main__":
    ...
    writer_name = "Writers/Try_overfit_mujoco/"
    save_path = "Models/Try_overfit_mujoco_100k"
    ...
    save_path = "Models/Try_overfit_mujoco_50k"
    ...
    save_path = "Models/Try_overfit_mujoco_10k"

    model_name = "end_to_end"
    test_name = "10K"
    manager = Manager(model_name=model_name, env_name=env_name, savepath=save_path, contrastive=True, perc=0,
                      writer_name=writer_name, test_aug=False, target=True, entire_trajectory=False, dimension=10000,
                      test_name=test_name)
